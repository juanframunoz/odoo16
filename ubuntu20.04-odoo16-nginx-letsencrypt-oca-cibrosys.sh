...
# Clonación del repositorio CybroAddons
echo "Clonando el repositorio CybroAddons..."
git clone https://github.com/CybroOdoo/CybroAddons.git /opt/odoo/extra-addons/CybroAddons

# Clonación del repositorio l10n-spain
echo "Clonando el repositorio l10n-spain..."
git clone https://github.com/OCA/l10n-spain.git /opt/odoo/extra-addons/l10n-spain
...
db_user = odoo
db_password = odoo
addons_path = /opt/odoo/addons,/opt/odoo/extra-addons,/opt/odoo/extra-addons/CybroAddons,/opt/odoo/extra-addons/l10n-spain
...
echo "Instalación y configuración de Odoo 16 completada, incluyendo los repositorios adicionales CybroAddons y l10n-spain."
